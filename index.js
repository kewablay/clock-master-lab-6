const clock = {
  ...
  color() {
    ...
    const hoursMin = document.getElementById("clock")

    hoursMin.style.color = color.value

    // hour.style.color = color.value
  },
  is24HourFormat: true,
  alarmTime: null,
    ...
    const template = `
        <div class="flex gap-4">
          ...
          <div  class="space-y-0 shrink-0 w-10 items-center justify-center flex flex-col">
            <p class="text-3xl font-bold text-[#949d9c]" style="color:${
              color.value
            };">${this.seconds.toString().padStart(2, "0")}</p>
    ...
    const template = `
        <div class="flex gap-4">
          ...
          <div class="space-y-0 shrink-0 w-10 items-center justify-center flex flex-col">
            ...
            <p class="text-[#949d9c] font-bold" style="color:${
              color.value
            }">${period}</p>
          </div>
        </div>
